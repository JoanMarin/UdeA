...
import com.udea.laboratorio2arquitectura.ejb.MateriaFacade;
...
public class MateriaController implements Serializable {
    ...
    @EJB
    private com.udea.laboratorio2arquitectura.ejb.MateriaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/message").getString("MateriaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/message").getString("MateriaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/message").getString("MateriaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
