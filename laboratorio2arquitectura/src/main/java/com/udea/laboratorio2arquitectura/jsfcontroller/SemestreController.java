...
import com.udea.laboratorio2arquitectura.ejb.SemestreFacade;
...
public class SemestreController implements Serializable {
    ...
    @EJB
    private com.udea.laboratorio2arquitectura.ejb.SemestreFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/message").getString("SemestreCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/message").getString("SemestreUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/message").getString("SemestreDeleted"));
        if (!JsfUtil.isValidationFailed()) {
